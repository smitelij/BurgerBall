...
public class Square {
    ...
    static float squareCoords[] = {
            40.0f,  40.0f, 0.0f,   // top left
            40.0f, 36.0f, 0.0f,   // bottom left
            44.0f, 36.0f, 0.0f,   // bottom right
            44.0f,  40.0f, 0.0f }; // top right
    ...
    public void setColor(int vertex, float change){
        color[vertex] = color[vertex]+ change;
    ...
    //public float[] getOverallColor(){ return color;}

   /* public void setOverallColor(float[] newColor){
        color = newColor;
    }*/
